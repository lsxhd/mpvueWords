  ...
  <div class="container ub-box ub-col">
    ...
    <!-- <dl class="ub-box ub-ver z-padding-v-10-px" style="background:#fff;">
      <dd
        ...
        class="z-padding-h-10-px ub-box ub-ver"
      >
      ...
      <dd class="ub-flex-1 ub-box ub-ver">
        <div
          @click.stop="$openWin('/pages/search/main')"
          class="search ub-box ub-ver-v z-width-90-percent z-box-sizing-border"
        >
          <i class="iconfont icon-sousuo z-color-666 z-font-size-16"></i>
          <span class="z-font-size-14 z-color-999 z-margin-left-8-px"
            >请输入书名、分类或者作者...</span
          >
        </div>
      </dd>
    ...
    <scroll-view scroll-y style="height: calc(100vh - 50px);" scroll-top="0">
      ...
      <dl
        class="ub-box ub-col z-margin-top-6-px z-padding-all-8-px"
        style="background:#fff"
      >
        <p
          class="z-width-100-percent ub-box ub-ver"
          style="border-bottom:1px solid #eee"
        >
          <span class="z-font-size-12 z-color-888 z-lineHeight-36"
            >—热门推荐—</span
          >
        </p>
...
import { getBookList } from "@/dao/modules/book";
export default {
  ...
  methods: {
    ...
    async initAjax() {
      let ret = await this.$ajax({
        url: "https://devapi.ynshuke.com/v1/banners"
      });
      console.log(ret);
    }
  },
